package com.ratio.domain.usecase.wallet

import arrow.core.Option
import com.ratio.data.model.Value
...
import com.ratio.domain.usecase.account.AccountBalanceUseCase
...
class WalletBalanceUseCase @Inject constructor(
    ...
    /**
     * Calculates the all-time balance of Ratio by summing
