...
class RatioRoomDatabaseMigrationTest {

    @get:Rule
    val helper: MigrationTestHelper = MigrationTestHelper(
        InstrumentationRegistry.getInstrumentation(),
        RatioRoomDatabase::class.java,
        listOf(RatioRoomDatabase.DeleteSEMigration()),
    ...
    fun migrateAll() {
        ...
        // for Ratio versions below 106 are broken :/
        ...
        Room.databaseBuilder(
            ...
            RatioRoomDatabase::class.java,
            TestDb
        ).addMigrations(*RatioRoomDatabase.migrations()).build().apply {
