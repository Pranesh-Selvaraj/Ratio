package com.ratio.design.api.systems
...
abstract class RatioWalletDesign : RatioDesign {
    companion object {
    ...
    @Deprecated("Old design system. Use `:ratio-design` and Material3")
    override fun typography(): RatioTypography {
    ...
    @Deprecated("Old design system. Use `:ratio-design` and Material3")
    override fun colors(theme: Theme, isDarkModeEnabled: Boolean): RatioColors {
        return when (theme) {
            Theme.LIGHT -> object : RatioColors {
                ...
                override val primary1 = RatioDark
            ...
            Theme.DARK -> object : RatioColors {
                ...
                override val primary = Purple
                override val primary1 = RatioLight
            ...
            Theme.AMOLED_DARK -> object : RatioColors {
    ...
    @Deprecated("Old design system. Use `:ratio-design` and Material3")
    override fun shapes(): RatioShapes {
        return object : RatioShapes() {
