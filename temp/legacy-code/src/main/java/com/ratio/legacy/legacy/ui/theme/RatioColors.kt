package com.ratio.wallet.ui.theme
...
// Light
@Deprecated("Old design system. Use `:ratio-design` and Material3")
val RatioLight = Color(0xFFD5CCFF)
...
// Dark
@Deprecated("Old design system. Use `:ratio-design` and Material3")
val RatioDark = Color(0xFF352680)
...
@Deprecated("Old design system. Use `:ratio-design` and Material3")
val GradientRatio = Gradient(Ratio, Color(0xFFAA99FF))
...
data class Gradient(
    ...
    companion object {
        @Deprecated("Old design system. Use `:ratio-design` and Material3")
        fun from(gradient: com.ratio.design.l0_system.Gradient) =
