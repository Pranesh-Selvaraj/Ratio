...
import com.ratio.base.time.INSTANT_MAX_SAFE
import com.ratio.base.time.INSTANT_MIN_SAFE
import com.ratio.base.time.TimeConverter
import com.ratio.frp.Total
...
fun ratioMinTime(): Instant = INSTANT_MIN_SAFE

fun ratioMaxTime(): Instant = INSTANT_MAX_SAFE
