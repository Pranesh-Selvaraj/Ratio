...
import com.ratio.legacy.data.model.filterOverdueLegacy
import com.ratio.legacy.data.model.filterUpcoming
import com.ratio.legacy.data.model.filterUpcomingLegacy
...
import com.ratio.wallet.domain.deprecated.logic.currency.ExchangeRatesLogic
import com.ratio.wallet.domain.deprecated.logic.currency.sumInBaseCurrency
...
class WalletCategoryLogic @Inject constructor(
    ...
    suspend fun calculateUnspecifiedBalance(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
        return calculateUnspecifiedIncome(range) - calculateUnspecifiedExpenses(range)
    }

    suspend fun calculateUnspecifiedIncome(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
        return transactionRepository
    ...
    suspend fun calculateUnspecifiedExpenses(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
        return transactionRepository
            .findAllUnspecifiedAndTypeAndBetween(
                type = TransactionType.EXPENSE,
                startDate = range.from(),
    ...
    suspend fun historyUnspecified(range: com.ratio.legacy.data.model.FromToTimeRange): List<TransactionHistoryItem> {
        return with(LegacyTrnDateDividers) {
            transactionRepository
    ...
    suspend fun calculateUpcomingIncomeUnspecified(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
    ...
    suspend fun calculateUpcomingExpensesUnspecified(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
        return upcomingUnspecifiedLegacy(range = range)
            .filter { it.type == TransactionType.EXPENSE }
            .sumInBaseCurrency(
                exchangeRatesLogic = exchangeRatesLogic,
    ...
    @Deprecated("Uses legacy Transaction")
    suspend fun upcomingUnspecifiedLegacy(range: com.ratio.legacy.data.model.FromToTimeRange): List<Transaction> {
    ...
    suspend fun calculateOverdueIncomeUnspecified(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
    ...
    suspend fun calculateOverdueExpensesUnspecified(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
        return overdueUnspecifiedLegacy(range = range)
            .filter { it.type == TransactionType.EXPENSE }
            .sumInBaseCurrency(
                exchangeRatesLogic = exchangeRatesLogic,
    ...
    @Deprecated("Uses legacy Transaction")
    suspend fun overdueUnspecifiedLegacy(range: com.ratio.legacy.data.model.FromToTimeRange): List<Transaction> {
        return transactionRepository.findAllDueToBetweenByCategoryUnspecified(
            startDate = range.from(),
            endDate = range.overdueTo(timeProvider)
        )
