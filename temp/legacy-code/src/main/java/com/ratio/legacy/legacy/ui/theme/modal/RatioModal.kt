...
import com.ratio.design.utils.rememberInteractionSource
...
import com.ratio.wallet.ui.theme.gradientCutBackgroundTop
import com.ratio.wallet.ui.theme.mediumBlur
...
@Preview
@Composable
private fun PreviewRatioModal_minimal() {
    RatioWalletPreview {
        RatioModal(
            id = UUID.randomUUID(),
            visible = true,
