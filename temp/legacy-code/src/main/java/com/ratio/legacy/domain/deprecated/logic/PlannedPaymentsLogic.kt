...
import com.ratio.data.temp.migration.settleNow
import com.ratio.legacy.datamodel.Account
import com.ratio.legacy.datamodel.PlannedPaymentRule
...
import com.ratio.wallet.domain.deprecated.logic.currency.sumByDoublePlannedInBaseCurrency
...
class PlannedPaymentsLogic @Inject constructor(
    ...
    suspend fun plannedPaymentsAmountFor(range: com.ratio.legacy.data.model.FromToTimeRange): Double {
    ...
    suspend fun payOrGet(
        transaction: com.ratio.data.model.Transaction,
        syncTransaction: Boolean = true,
        skipTransaction: Boolean = false,
        onUpdateUI: suspend (paidTransaction: com.ratio.data.model.Transaction) -> Unit
    ) {
    ...
    suspend fun payOrGet(
        transactions: List<com.ratio.data.model.Transaction>,
        syncTransaction: Boolean = true,
        skipTransaction: Boolean = false,
        onUpdateUI: suspend (paidTransactions: List<com.ratio.data.model.Transaction>) -> Unit
    ) {
        val paidTransactions: List<com.ratio.data.model.Transaction> =
