...
import com.ratio.legacy.utils.ratioMaxTime
...
fun Iterable<com.ratio.data.model.Transaction>.filterUpcoming(): List<com.ratio.data.model.Transaction> {
...
fun Iterable<com.ratio.data.model.Transaction>.filterOverdue(): List<com.ratio.data.model.Transaction> {
    val todayStartOfDayUTC = dateNowUTC().atStartOfDay().toInstant(ZoneOffset.UTC)
