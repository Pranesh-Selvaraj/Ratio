...
import com.ratio.frp.Pure
import com.ratio.frp.SideEffect
...
import com.ratio.legacy.utils.toEpochSeconds
import com.ratio.wallet.domain.data.TransactionHistoryDateDivider
...
import com.ratio.wallet.domain.pure.transaction.LegacyTrnFunctions
...
object LegacyTrnDateDividers {
    @Deprecated("Migrate to actions")
    suspend fun List<com.ratio.base.legacy.Transaction>.withDateDividers(
        exchangeRatesLogic: ExchangeRatesLogic,
        settingsDao: SettingsDao,
        accountDao: AccountDao,
    ...
    @Pure
    suspend fun transactionsWithDateDividers(
        transactions: List<com.ratio.base.legacy.Transaction>,
        baseCurrencyCode: String,
        timeConverter: TimeConverter,
