package com.ratio.wallet.domain.deprecated.logic.csv
...
import com.ratio.wallet.domain.deprecated.logic.csv.model.JoinResult
import com.ratio.wallet.domain.deprecated.logic.csv.model.RowMapping
...
class CSVMapper @Inject constructor() {
    ...
    private fun ratioMappingV1() = RowMapping(
        date = 0,
        title = 1,
        category = 2,
        account = 3,
    ...
    private fun ratioMappingV2() = RowMapping(
        date = 0,
        title = 1,
        category = 2,
        account = 3,
