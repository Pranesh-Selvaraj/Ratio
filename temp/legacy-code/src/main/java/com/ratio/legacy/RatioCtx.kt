...
@Singleton
class RatioCtx @Inject constructor() : RatioContext() {
    // ------------------------------------------ State ---------------------------------------------
    @Deprecated("Legacy code. Don't use it, please.")
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var selectedPeriod: com.ratio.legacy.data.model.TimePeriod =
        com.ratio.legacy.data.model.TimePeriod.currentMonth(
    ...
    ): com.ratio.legacy.data.model.TimePeriod {
        if (!selectedPeriodInitialized || forceReinitialize) {
            selectedPeriod = com.ratio.legacy.data.model.TimePeriod.currentMonth(
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun updateSelectedPeriodInMemory(period: com.ratio.legacy.data.model.TimePeriod) {
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var mainTab by mutableStateOf(com.ratio.legacy.data.model.MainTab.HOME)
        private set

    @Deprecated("Legacy code. Don't use it, please.")
    fun selectMainTab(tab: com.ratio.legacy.data.model.MainTab) {
        mainTab = tab
    }
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun reset() {
        mainTab = com.ratio.legacy.data.model.MainTab.HOME
        startDayOfMonth = 1
        isPremium = true
