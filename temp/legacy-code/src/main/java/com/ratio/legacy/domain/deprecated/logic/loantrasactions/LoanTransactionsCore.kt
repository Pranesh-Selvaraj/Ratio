package com.ratio.legacy.domain.deprecated.logic.loantrasactions
...
class LoanTransactionsCore @Inject constructor(
    ...
    private suspend fun getCategoryId(existingCategoryId: UUID? = null): UUID? {
        ...
        } ?: if (ratioContext.isPremium || categoryList.size < 12) {
            addCategoryToDb = true

            Category(
                name = NotBlankTrimmedString.unsafe("Loans"),
                color = ColorInt(RATIO_COLOR_PICKER_COLORS_FREE[DEFAULT_COLOR_INDEX].toArgb()),
