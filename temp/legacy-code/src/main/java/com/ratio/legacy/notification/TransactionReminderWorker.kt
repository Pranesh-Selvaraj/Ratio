package com.ratio.wallet.domain.deprecated.logic.notification
...
import com.ratio.legacy.utils.atEndOfDay
import com.ratio.ui.R
import com.ratio.wallet.android.notification.RatioNotificationChannel
import com.ratio.wallet.android.notification.NotificationService
    ...
    override suspend fun doWork() = withContext(Dispatchers.IO) {
        ...
        if (transactionsToday.size < MINIMUM_TRANSACTIONS_PER_DAY && showNotifications) {
            ...
            val notification = notificationService
                .defaultRatioNotification(
                    channel = RatioNotificationChannel.TRANSACTION_REMINDER,
