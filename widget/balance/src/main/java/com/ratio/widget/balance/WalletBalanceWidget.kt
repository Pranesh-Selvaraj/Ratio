package com.ratio.widget.balance
...
import com.ratio.legacy.utils.shortenAmount
...
import com.ratio.widgets.WidgetBase
...
class WalletBalanceWidgetReceiver : GlanceAppWidgetReceiver() {
    ...
    @Inject
    lateinit var ratioContext: com.ratio.legacy.RatioCtx
    ...
    private fun updateData(context: Context) {
        coroutineScope.launch {
            ...
            val appLocked = com.ratio.legacy.utils.ioThread {
            ...
            val period = ratioContext.selectedPeriod
