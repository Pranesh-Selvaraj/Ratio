package com.ratio.onboarding.viewmodel
...
import com.ratio.legacy.LogoutLogic
...
import com.ratio.legacy.utils.OpResult
import com.ratio.legacy.utils.ioThread
import com.ratio.navigation.Navigation
import com.ratio.navigation.OnboardingScreen
import com.ratio.onboarding.OnboardingDetailState
import com.ratio.onboarding.OnboardingEvent
import com.ratio.onboarding.OnboardingState
...
import com.ratio.wallet.domain.deprecated.logic.PreloadDataLogic
...
import com.ratio.wallet.domain.deprecated.logic.notification.TransactionReminderLogic
...
class OnboardingViewModel @Inject constructor(
    ...
    private val _currency = mutableStateOf(RatioCurrency.getDefault())
    ...
    private suspend fun initiateSettings(isSystemDarkMode: Boolean) {
        val defaultCurrency = RatioCurrency.getDefault()
    ...
    private suspend fun setBaseCurrency(baseCurrency: RatioCurrency) {
    ...
    private suspend fun updateBaseCurrency(baseCurrency: RatioCurrency) {
        ioThread {
            settingsWriter.save(
