...
import com.ratio.legacy.utils.springBounceSlow
    ...
    val spacerTop by transition.animateDp(
        ...
        when (it) {
            OnboardingState.SPLASH -> {
                (ratioContext.screenHeight / 2f - logoHeight.toDensityPx() / 2f).toDensityDp()
            }
        ...
        Image(
            modifier = Modifier
                ...
                .layout { measurable, constraints ->
                    ...
                    val xSplash = ratioContext.screenWidth / 2f - placeable.width / 2
            ...
            painter = painterResource(id = R.drawable.ratio_logo),
            contentScale = ContentScale.FillBounds,
            contentDescription = "Ratio logo"
        )
