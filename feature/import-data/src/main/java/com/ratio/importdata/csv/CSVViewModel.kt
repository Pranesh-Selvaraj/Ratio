package com.ratio.importdata.csv
...
import com.ratio.importdata.csv.domain.CSVImporterV2
import com.ratio.importdata.csv.domain.SAMPLE_SIZE
import com.ratio.importdata.csv.domain.parseAccount
import com.ratio.importdata.csv.domain.parseAccountCurrency
import com.ratio.importdata.csv.domain.parseAmount
import com.ratio.importdata.csv.domain.parseCategory
import com.ratio.importdata.csv.domain.parseDate
import com.ratio.importdata.csv.domain.parseDescription
import com.ratio.importdata.csv.domain.parseStatus
import com.ratio.importdata.csv.domain.parseTitle
import com.ratio.importdata.csv.domain.parseToAccount
import com.ratio.importdata.csv.domain.parseToAccountCurrency
import com.ratio.importdata.csv.domain.parseTransactionType
import com.ratio.navigation.Navigation
import com.ratio.data.file.FileSystem
...
class CSVViewModel @Inject constructor(
    ...
    private var accountCurrency by mutableStateOf(
        ColumnMapping(
            ratioColumn = "Account Currency",
            helpInfo = """
                The currency of the account that made the transaction.
                In Ratio, transactions don't have a currency but inherit
    ...
    private var toAccountCurrency by mutableStateOf(
        ColumnMapping(
            ratioColumn = "To Account Currency",
            helpInfo = """
        ...
        withContext(Dispatchers.IO) {
            val result = csvImporter.import(
                ...
                onProgress = { progressPercent ->
                    com.ratio.legacy.utils.uiThread {
