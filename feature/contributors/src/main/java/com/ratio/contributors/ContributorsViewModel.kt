...
class ContributorsViewModel @Inject constructor(
    private val ratioRepositoryDataSource: RatioRepositoryDataSource,
    ...
    private suspend fun fetchContributors() {
        val contributorsResult = ratioRepositoryDataSource.fetchContributors()
    ...
    private suspend fun fetchProjectInfo() {
        val responseInfo = ratioRepositoryDataSource.fetchRepositoryInfo()
