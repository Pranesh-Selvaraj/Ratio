...
import com.ratio.wallet.ui.theme.RatioLight
import com.ratio.wallet.ui.theme.Orange
import com.ratio.wallet.ui.theme.Red
import com.ratio.wallet.ui.theme.RedLight
import com.ratio.wallet.ui.theme.White
import com.ratio.wallet.ui.theme.components.BalanceRow
import com.ratio.wallet.ui.theme.components.BalanceRowMini
import com.ratio.wallet.ui.theme.components.CircleButtonFilledGradient
import com.ratio.wallet.ui.theme.components.CloseButton
import com.ratio.wallet.ui.theme.components.ItemIconM
...
import com.ratio.wallet.ui.theme.gradientExpenses
import com.ratio.wallet.ui.theme.modal.ChoosePeriodModal
import com.ratio.wallet.ui.theme.pureBlur
...
private fun BoxWithConstraintsScope.UI(
    ...
    val percentExpanded by animateFloatAsState(
        ...
        animationSpec = com.ratio.legacy.utils.springBounce(),
...
private fun Header(
    ...
    period: com.ratio.legacy.data.model.TimePeriod,
            ...
            if (percentExpanded > 0f) {
                ...
                CircleButtonFilledGradient(
                    modifier = Modifier
                        ...
                        .alpha(percentExpanded)
                        .size(com.ratio.legacy.utils.lerp(1, 40, percentExpanded).dp),
                    iconPadding = 4.dp,
...
private fun Preview_Expense() {
    com.ratio.legacy.RatioWalletPreview {
        val state = PieChartStatisticState(
            ...
            period = com.ratio.legacy.data.model.TimePeriod.currentMonth(
                startDayOfMonth = 1
            ), // preview
            baseCurrency = "BGN",
            totalAmount = 1828.0,
            categoryAmounts = persistentListOf(
                ...
                CategoryAmount(
                    category = Category(
                        ...
                        color = ColorInt(RatioLight.toArgb()),
