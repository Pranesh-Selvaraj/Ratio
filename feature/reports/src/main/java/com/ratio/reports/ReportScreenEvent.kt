...
sealed class ReportScreenEvent {
    ...
    data class SkipTransactionsLegacy(val transactions: List<com.ratio.base.legacy.Transaction>) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class SkipTransactionLegacy(val transaction: com.ratio.base.legacy.Transaction) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class OnPayOrGetLegacy(val transaction: com.ratio.base.legacy.Transaction) :
        ReportScreenEvent()
}
