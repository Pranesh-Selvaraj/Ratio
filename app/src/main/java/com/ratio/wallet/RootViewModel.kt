...
import com.ratio.wallet.migrations.MigrationsManager
    ...
    fun start(systemDarkMode: Boolean, intent: Intent) {
        viewModelScope.launch {
            ...
            ioThread {
                ...
                ratioContext.switchTheme(theme)

                ratioContext.initStartDayOfMonthInMemory(sharedPrefs = sharedPrefs)
            }
