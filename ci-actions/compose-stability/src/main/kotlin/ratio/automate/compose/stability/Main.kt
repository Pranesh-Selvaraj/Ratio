package ratio.automate.compose.stability
...
import ratio.automate.compose.stability.model.ComposableArgument
import ratio.automate.compose.stability.model.FullyQualifiedName
import ratio.automate.compose.stability.model.UnstableComposable
import java.io.File
import kotlin.system.exitProcess

const val OutputReportFileName = "ratio-compose-stability-report.txt"
const val ComposeReportFolderName = "compose_compiler"
const val BaselineArg = "generateBaseline"
const val BaselineFileName = "ratio-compose-stability-baseline.txt"
...
fun main(args: Array<String>) {
    ...
    val ratioReportTxt = buildRatioReport(unstableComposables)
    createReportFile(ratioReportTxt)
    println(ratioReportTxt)
