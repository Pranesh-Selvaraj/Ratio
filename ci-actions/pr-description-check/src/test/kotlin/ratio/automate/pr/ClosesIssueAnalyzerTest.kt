    ...
    enum class PRDescTestCase(
        ...
        VALID_SHORT_1(
            prDescription = """
                ...
                - [x] I've read the [Contribution Guidelines](https://github.com/Pranesh-Selvaraj/Ratio/blob/main/CONTRIBUTING.md) and my PR doesn't break the rules.
                - [x] I've read and understand the [Developer Guidelines](https://github.com/Pranesh-Selvaraj/Ratio/blob/main/docs/Guidelines.md).
        ...
        INVALID_DEFAULT_TEMPLATE(
            prDescription = """
                ...
                Please check if your pull request fulfills the following requirements:
                <!--💡 Tip: Tick checkboxes like this: [x] 💡-->
                - [ ] I've read the [Contribution Guidelines](https://github.com/Pranesh-Selvaraj/Ratio/blob/main/CONTRIBUTING.md) and my PR doesn't break the rules.
                - [ ] I've read and understand the [Developer Guidelines](https://github.com/Pranesh-Selvaraj/Ratio/blob/main/docs/Guidelines.md).
                ...
                **In what cases won't your code work?**
                ...
                <!--💡 Tip: Replace {ISSUE_NUMBER} with the number of Ratio ISSUE (https://github.com/Pranesh-Selvaraj/Ratio/issues)(❗NOT PR❗) which this pull request fixes. If done correctly, you'll see the issue title linked on PR preview. 💡-->
                <!--💡 Tip: Multiple issues:
                ...
                Pull request checks failing? Read our [CI Troubleshooting guide](https://github.com/Pranesh-Selvaraj/Ratio/blob/main/docs/CI-Troubleshooting.md).
            """.trimIndent(),
            expectedResult = Either.Left(ClosesIssueAnalyzer.MissingClosesProblem),
        ),
